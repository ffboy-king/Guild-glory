...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="4376930162", password="FEE1B5B06FAC1CCDB0323285925AD0728AF6AD7E2CEBB18DA96E24C2C9394323")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")

        client_thread = FF_CLIENT(id="4376960660", password="B67780B0841616DDBEC988F27333512EB89E066ACCC7AE2BB7AFA2DFBA4405FD")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
        
        client_thread = FF_CLIENT(id="4377319254", password="BBE2DB6C2284D80C0243ADEC2559ABFB6182596F729AAB5796F6EA5DDE7A2270")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
        
        client_thread = FF_CLIENT(id="4377336248", password="865336BECFB57A76E4AB7851637986E39C71D62680A0643B5E6C4FC6E898B254")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
        
        client_thread = FF_CLIENT(id="4377346841", password="32DE03602CB451855793D6C974D59CC8D1EED11B43DBF3873901C30EBA7C79C1")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
